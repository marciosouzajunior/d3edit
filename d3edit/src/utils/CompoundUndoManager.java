...
/*
 ** This class will merge individual edits into a single larger edit. * That
 * is, characters entered sequentially will be grouped together and * undone as
 * a group. Any attribute changes will be considered as part * of the group and
 * will therefore be undone when the group is undone.
 */
